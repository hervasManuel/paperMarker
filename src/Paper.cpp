...
void Paper::rotateYAxis(Mat &rotation){
  cv::Mat rot3x3(3,3,CV_32F);
  Rodrigues(rotation, rot3x3);
  ...
  float angleRad = M_PI;
  rotY.at<float>(0,0)=cos(angleRad);
  rotY.at<float>(0,2)=sin(angleRad);
  rotY.at<float>(2,0)=-sin(angleRad);
  rotY.at<float>(2,2)=cos(angleRad);
...
void Paper::rotateYAxis2(Mat &rotation){
  cv::Mat rot3x3(3,3,CV_32F);
  Rodrigues(rotation, rot3x3);
...
void Paper::rotateZAxis(Mat &rotation){
  cv::Mat rot3x3(3,3,CV_32F);
  Rodrigues(rotation, rot3x3);
  ...
  float angleRad = M_PI;
  rotZ.at<float>(0,0)=cos(angleRad);
  rotZ.at<float>(0,1)=-sin(angleRad);
  rotZ.at<float>(1,0)=sin(angleRad);
  rotZ.at<float>(1,1)=cos(angleRad);
